module "wrapper" {
  ...
  collection_group_capacity_limits_max_indexing_capacity_in_ocu = try(each.value.collection_group_capacity_limits_max_indexing_capacity_in_ocu, var.defaults.collection_group_capacity_limits_max_indexing_capacity_in_ocu, 1)
  collection_group_capacity_limits_max_search_capacity_in_ocu   = try(each.value.collection_group_capacity_limits_max_search_capacity_in_ocu, var.defaults.collection_group_capacity_limits_max_search_capacity_in_ocu, 96)
  collection_group_capacity_limits_min_indexing_capacity_in_ocu = try(each.value.collection_group_capacity_limits_min_indexing_capacity_in_ocu, var.defaults.collection_group_capacity_limits_min_indexing_capacity_in_ocu, 1)
  collection_group_capacity_limits_min_search_capacity_in_ocu   = try(each.value.collection_group_capacity_limits_min_search_capacity_in_ocu, var.defaults.collection_group_capacity_limits_min_search_capacity_in_ocu, 96)
  collection_group_description                                  = try(each.value.collection_group_description, var.defaults.collection_group_description, "")
  collection_group_name                                         = try(each.value.collection_group_name, var.defaults.collection_group_name, "")
  collection_group_standby_replicas                             = try(each.value.collection_group_standby_replicas, var.defaults.collection_group_standby_replicas, "ENABLED")
  create                                                        = try(each.value.create, var.defaults.create, true)
  create_access_policy                                          = try(each.value.create_access_policy, var.defaults.create_access_policy, false)
  create_collection_group                                       = try(each.value.create_collection_group, var.defaults.create_collection_group, false)
