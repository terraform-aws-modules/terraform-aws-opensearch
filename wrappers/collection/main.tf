module "wrapper" {
  ...
  collection_group_capacity_limits        = try(each.value.collection_group_capacity_limits, var.defaults.collection_group_capacity_limits, null)
  collection_group_description            = try(each.value.collection_group_description, var.defaults.collection_group_description, null)
  collection_group_generation             = try(each.value.collection_group_generation, var.defaults.collection_group_generation, null)
  collection_group_name                   = try(each.value.collection_group_name, var.defaults.collection_group_name, null)
